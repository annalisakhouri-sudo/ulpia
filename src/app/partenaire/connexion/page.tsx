...
import { partnerLogin } from "@/lib/partner-auth-actions";
    ...
    <main className="min-h-screen flex items-center justify-center bg-background px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface border border-line rounded-lg p-8">
          <h1 className="font-display text-xl mb-6">Connexion partenaire</h1>
        ...
        <p className="mt-6 text-center text-sm text-ink-soft">
          ...
          <Link href="/partenaire/inscription" className="text-brass hover:underline">
            Créer un compte
          </Link>
        </p>
        <p className="mt-2 text-center text-xs text-ink-soft">
          <Link href="/connexion" className="hover:underline">
            Vous êtes une entreprise ? Connectez-vous ici
          </Link>
        </p>
      </div>
    </main>
